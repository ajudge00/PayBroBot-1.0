"""
    A fő (/-jellel ellátott parancsokat kezeli.
    A legtöbb command innen a convo_handlerbe irányít át.
"""

from paybrobot.utils import globals
from paybrobot.main.convo_handler import UserHandler, AccountHandler, TransferHandler
